...
AEM UI Extension is a module responsible for provide graphic user interface for 
WebSight in AEM Tools (as a new tab).
...
Dynamic Solutions WebSight (AEM UI Extension) - AEM UI Extension module
